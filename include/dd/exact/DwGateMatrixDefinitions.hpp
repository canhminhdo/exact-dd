...
[[nodiscard]] const std::array<Dw, 4> &i();
[[nodiscard]] const std::array<Dw, 4> &x();
[[nodiscard]] const std::array<Dw, 4> &y();
[[nodiscard]] const std::array<Dw, 4> &z();
[[nodiscard]] const std::array<Dw, 4> &h();
[[nodiscard]] const std::array<Dw, 4> &s();
[[nodiscard]] const std::array<Dw, 4> &sdg();
[[nodiscard]] const std::array<Dw, 4> &t();
[[nodiscard]] const std::array<Dw, 4> &tdg();
[[nodiscard]] const std::array<Dw, 4> &v();
[[nodiscard]] const std::array<Dw, 4> &vdg();
[[nodiscard]] const std::array<Dw, 4> &sx();
[[nodiscard]] const std::array<Dw, 4> &sxdg();
...
[[nodiscard]] const std::array<Dw, 16> &swap();
[[nodiscard]] const std::array<Dw, 16> &iswap();
[[nodiscard]] const std::array<Dw, 16> &iswapdg();
[[nodiscard]] const std::array<Dw, 16> &dcx();
...
[[nodiscard]] const std::array<Dw, 4> &byName(const std::string &name);
...
[[nodiscard]] const std::array<Dw, 16> &twoQubitByName(const std::string &name);
